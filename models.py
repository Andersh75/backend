...
class Courses(db.Model):
    ...
    periodone = db.Column(db.Boolean, default=False)
    periodtwo = db.Column(db.Boolean, default=False)
    periodthree = db.Column(db.Boolean, default=False)
    periodfour = db.Column(db.Boolean, default=False)
